...
@dataclass
class LLaMaInstructSpecialTokens:
    ...
    role_start_token: str = "<|start_header_id|>"
    role_end_token: str = "<|end_header_id|>"
    ...
    def chat_template(self):
        ...
        return (self.bos_token +
            ...
            f"{{{{'{self.role_start_token}' + message['role'] + '{self.role_end_token}' + '\n\n' + {curly_braces_start} + message['content'] + {curly_braces_end} + '{self.stop_token}'}}}}"
            "{% endfor %}"
...
FORMAT_MAPPING = {"chatml": ChatMlSpecialTokens, "llama3": LLaMaInstructSpecialTokens}


def setup_chat_format(
    model: PreTrainedModel,
    tokenizer: PreTrainedTokenizer,
    format: Optional[Literal["llama3"]] = "llama3",
